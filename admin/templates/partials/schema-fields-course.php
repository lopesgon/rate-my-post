...
<div class="rmp-customize-mb__schema__schema-field js-rmp-schema-course">
  <h3>Course</h3>
  <div class="rmp-schema-input js-rmp-schema-field" data-schema-key="provider">
    <label class="rmp-schema-input__label" for="rmp-schema-provider">
      <?php echo ( esc_html__( 'Provider', 'rate-my-post' ) ); ?>
    </label>
    <input
      type="text"
      class="rmp-schema-input__input"
      id="rmp-schema-provider"
    >
