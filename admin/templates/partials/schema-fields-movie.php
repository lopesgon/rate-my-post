...
<div class="rmp-customize-mb__schema__schema-field js-rmp-schema-movie">
  <h3>Movie</h3>
  <div class="rmp-schema-input js-rmp-schema-field" data-schema-key="dateCreated">
    <label class="rmp-schema-input__label" for="rmp-schema-dateCreated">
      <?php echo ( esc_html__( 'Date Created', 'rate-my-post' ) ); ?>
    </label>
    <input
      type="text"
      class="rmp-schema-input__input"
      id="rmp-schema-dateCreated"
    >
